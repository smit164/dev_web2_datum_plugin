...
<div id="key-fields" class="settings-panel">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="key_description">
						...
						<?php echo dm_help_tip( __( 'Friendly name for identifying this key.', 'woocommerce' ) ); ?>
					</label>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="key_user">
						...
						<?php echo dm_help_tip( __( 'Owner of these keys.', 'woocommerce' ) ); ?>
					</label>
				</th>
				<td class="forminp">
					<?php
					...
					?>
					<select class="dm-customer-search" id="key_user" data-placeholder="<?php esc_attr_e( 'Search for a user&hellip;', 'woocommerce' ); ?>" data-allow_clear="true">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					<label for="key_permissions">
						...
						<?php echo dm_help_tip( __( 'Select the access type of these keys.', 'woocommerce' ) ); ?>
					</label>
				</th>
				<td class="forminp">
					<select id="key_permissions" class="dm-enhanced-select">
						<?php
						$permissions = array(
				...
				<tr valign="top">
					...
					<td class="forminp">
						...
						if ( ! empty( $key_data['last_access'] ) ) {
							...
							$date = sprintf( __( '%1$s at %2$s', 'woocommerce' ), date_i18n( dm_date_format(), strtotime( $key_data['last_access'] ) ), date_i18n( dm_time_format(), strtotime( $key_data['last_access'] ) ) );
	...
	if ( 0 === intval( $key_id ) ) {
		...
		<p class="submit">
			...
			<a style="color: #a00; text-decoration: none; margin-left: 10px;" href="<?php echo esc_url( wp_nonce_url( add_query_arg( array( 'revoke-key' => $key_id ), admin_url( 'admin.php?page=dm-settings&tab=advanced&section=keys' ) ), 'revoke' ) ); ?>"><?php esc_html_e( 'Revoke key', 'woocommerce' ); ?></a>
		</p>
		<?php
	}
	?>
