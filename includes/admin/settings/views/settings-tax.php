...
$settings = array(
	...
	'shipping-tax-class' => array(
		...
		'type'     => 'select',
		'class'    => 'dm-enhanced-select',
		'options'  => array( 'inherit' => __( 'Shipping tax class based on cart items', 'woocommerce' ) ) + dm_get_product_tax_class_options(),
		'desc_tip' => true,
	),
